...
func GetMiningInfo()models.MiningInfo  {
	rpcrequest:=models.RPCRequest{
		Id:      time.Now().Unix(),
		Method:models.GETMININGINFO ,
...
func getbody(body []byte)models.MiningInfo {
	var mining models.Mining
	json.Unmarshal([]byte(body),&mining)
